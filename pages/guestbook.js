...
const AppHead = () => (
  <Head>
    ...
    <meta charSet="utf-8" />
    <title>BGB Financial Guestbook</title>
...
const EntryItem = ({ entry }) => (
  <div className="flex flex-col space-y-2">
    <div className="w-full prose dark:prose-dark">{entry.message}</div>
...
const EntryForm = ({ onSubmit: onSubmitProp }) => {
  ...
  return (
    <>
      <form className="relative flex my-4" onSubmit={onSubmit}>
        <input
          required
...
const Guestbook = ({ initialEntries }) => {
  ...
  return (
    <main className="max-w-4xl p-4 mx-auto">
      ...
      <div className="px-2 mt-4 space-y-8">
        {entries?.map((entry) => (
