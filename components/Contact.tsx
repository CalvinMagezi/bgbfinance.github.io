  ...
  return (
    ...
    >
      ...
      <Grid className="w-full grid-cols-1 gap-3 lg:grid-cols-2 lg:px-32">
        <GridItem className="w-full px-1 py-5 text-black bg-white rounded-md shadow-lg lg:col-span-2">
        ...
        <GridItem className="w-full px-1 py-5 text-black bg-white rounded-md shadow-lg ">
          <Flex className="flex-col items-center text-center">
